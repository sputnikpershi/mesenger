...
#### Стэк текхнологий:
 ...
 В приложении реализована авторизация через FireBase: тестовый номер телефона (966-966-66-66)  и код (666-666). Проверить регистрацию можно введя любой номер и любой код. 
